...
# 修改 IMG_PREFIX 定义（大约在第90行）
IMG_PREFIX:=$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)$(BOARD)-$(SUBTARGET)-$(KERNEL_VER)-$(BUILD_DATE)
